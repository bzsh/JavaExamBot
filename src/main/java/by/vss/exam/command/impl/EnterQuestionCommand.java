...
public class EnterQuestionCommand implements Command {
    ...
    public CommandResult execute(Message message, boolean isCallback, String callbackId) {
        ...
        createCardSeance.setCreateCardStage(CreateCardStage.RECEIVED_QUESTION);
        String response = " - Введите вопрос";
